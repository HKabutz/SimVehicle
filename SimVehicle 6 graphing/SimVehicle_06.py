...
if __name__ == '__main__':
    ...
    plt.plot(sim1.temp_p_hist_x[2:-1] -0.8, sim1.temp_p_hist_y[2:-1],"r-",label='Simulated combined controller',linewidth=2)
    plt.plot(a_GPS_PosLog[:, 1] / 100 , a_GPS_PosLog[:, 2] / 100 - 1.8, "m.", markersize=5, label="Actual Path")
    ...
    plt.plot(sim1.temp_p_hist_x[2:-1] -0.8, sim1.temp_p_hist_steer[2:-1],"r-",label='Simulated combined controller',linewidth=2)
    plt.plot(a_GPS_PosLog[:, 1] / 100 , -a_ControllerLog[:,3], "m.", label="Actual Steering", markersize=5)
    ...
    plt.savefig('img_LateralControl_simulate_combined.png', dpi=500, bbox_inches='tight')
    # plt.subplot(212)
