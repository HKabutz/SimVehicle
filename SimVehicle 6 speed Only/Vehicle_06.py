...
#* Dynamic model
    def model(self,z,t,V,delta):
        ...
        alpha_f = beta + (self.Lf/(V+0.00000000000001))*psidot - delta
        alpha_r = beta - (self.Lr/(V+0.00000000000001))*psidot
        ...
        dydt = V*beta
        dbetadt = 2/(self.mass*V+0.000000000000001)*Ff + 2/(self.mass*V+0.000000000000001)*Fr - psidot
        dpsidt = psidot
